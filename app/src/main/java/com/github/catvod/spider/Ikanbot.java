...
public class Ikanbot extends Spider {
    ...
    public String detailContent(List<String> ids) throws Exception {
        ...
        for (JsonElement element : array) {
            ...
            Matcher matcher = pattern
                    .matcher(String.valueOf(element.getAsJsonObject().get("resData")).replace("\\", ""));
            String flag = "";
            String liUrl = "";
            // 提取匹配到的内容
            if (matcher.find()) {
            ...
            // PlayUrl +=
            // String.valueOf(element.getAsJsonObject().get("resData")).replace("\\","").replace("\\\"","\"");
        }
        Vod vod = new Vod();
    ...
    // let _0x23e537 = parseInt(_0x52a097[_0x570711]), _0x48b93d = _0x23e537 % 0x3 +
    // 0x1;
